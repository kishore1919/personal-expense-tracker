      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-10">
        <Card className="lg:col-span-2">
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold text-gray-800">Your Expense Books</h2>
            <button onClick={() => setIsModalOpen(true)} className="bg-indigo-600 text-white px-6 py-3 rounded-xl font-semibold flex items-center shadow-lg hover:bg-indigo-700 transition-all ml-4 whitespace-nowrap">
              ...
              <div key={book.id} className="bg-white p-5 rounded-2xl shadow-sm hover:shadow-lg transition-shadow flex items-center justify-between group border border-gray-100">
                ...
                <div className="flex items-center">
                  <div className="mr-10 text-right">
                    <div className="font-extrabold text-gray-800 text-2xl">$0</div>
          ...
          <Card>
            ...
            <div className="space-y-3">
                <button className="w-full text-left p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors flex items-center">
                 ...
                 <button onClick={() => setIsModalOpen(true)} className="w-full text-left p-4 rounded-lg bg-gray-50 hover:bg-gray-100 transition-colors flex items-center">
          ...
          <Card>
            ...
            <div className="space-y-4">
              <div className="flex items-center">
                ...
                <div>
                  <p className="font-semibold text-gray-700">+$50.00 for groceries</p>
                  <p className="text-sm text-gray-400">2 hours ago</p>
                </div>
              </div>
              <div className="flex items-center">
                <div className="w-10 h-10 bg-red-100 text-red-600 rounded-full flex items-center justify-center mr-4 font-bold">M</div>
                <div>
                  <p className="font-semibold text-gray-700">-$12.99 for movie ticket</p>
